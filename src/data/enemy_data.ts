...
export const ENEMY_KIND_MAP: Record<string, EnemyKindInfo> = {
    ...
    "strong_physical":       { max_speed: 0.8,  screen_size: 1.0, fps: 12, name: "strong_physical",       sprite_type: "enemy_strong_walk",    anim_type: 'rock',       loop_style: 'linear' },
    "running_physical":      { max_speed: 2.0,  screen_size: 1.0, fps: 10, name: "running_physical",      sprite_type: "enemy_running_walk",   anim_type: 'scuttle',    loop_style: 'linear' },
